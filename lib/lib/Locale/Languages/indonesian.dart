...
Map<String, String> indonesian() {
  ...
  return {
    ...
    'verifyDescription':'Kami telah menghantar SMS dengan kod pengesahan kepada',
  ...
  'snoozeMedicine': 'Peringatan ${box.read('medicine') ?? 'medicine 1'} tunda',
  'snoozeMedicine2': 'Peringatan ${box.read('medicine2') ?? 'medicine 2'} tunda',
    ...
    'cancelReminder1': 'Peringatan ${box.read('medicine1') ?? 'ubat 1'} dibatalkan',
    'cancelReminder2': 'Peringatan ${box.read('medicine2') ?? 'ubat 2'} dibatalkan',
    'update': 'Kemas kini',

                        ...
                        ElevatedButton(
                            ...
                            onPressed: () async {
                              var openAppResult = await LaunchApp.openApp(
                                ...
                                iosUrlScheme: 'maybank2u-my://',
                                appStoreLink:
                                    'itms-apps://apps.apple.com/my/app/maybank2u-my/id1192180092',
                                // openStore: false
                              );
                              print(
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () async {
                              var openAppResult = await LaunchApp.openApp(
                                ...
                                iosUrlScheme: 'cimb-malaysia://',
                                appStoreLink:
                                    'itms-apps://apps.apple.com/my/app/cimb-clicks-malaysia/id328803038',
                                // openStore: false
                              );
                              print(
                                  'openAppResult => $openAppResult ${openAppResult.runtimeType}');

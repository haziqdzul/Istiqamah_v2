...
class Utils {
  ...
  ///TODO The list of days in a given month
  static List<DateTime> daysInMonth(DateTime month) {
    ...
    //TODO If the last day is sunday (7) the entire week must be rendered
    if (daysAfter == 0) {
      daysAfter = 7;
    }
  ...
  static DateTime firstDayOfWeek(DateTime day) {
    ///TODO Handle Daylight Savings by setting hour to 12:00 Noon rather than the default of Midnight
    day = DateTime.utc(day.year, day.month, day.day, 12);

    ///TODO Weekday is on a 1-7 scale Monday - Sunday,
  ...
  static DateTime lastDayOfWeek(DateTime day) {
    ///TODO Handle Daylight Savings by setting hour to 12:00 Noon
  ...
  ///TODO The last day of a given month
  ...
  ///TODO Whether or not two times are on the same day.
